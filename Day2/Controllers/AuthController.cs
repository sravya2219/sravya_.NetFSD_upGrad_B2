...
namespace API.Controllers
{
    ...
    public class AuthController(AppDbContext context, ILogger<ContactController> logger) : ControllerBase   // ✅ FIXED
    {
        private readonly AppDbContext _context = context;
        private readonly ILogger<AuthController> _logger = (ILogger<AuthController>)logger;
